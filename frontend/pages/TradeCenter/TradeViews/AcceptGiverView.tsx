            ...
            <Transition
                ...
                <div className="w-full flex flex-col justify-center items-center"> 
                    {trade.receiver_exchanging.length == 0 ? (
                        <div> 
                            You're giving away these items to <b>{trade.receiver.username}</b> at <b>{meetingtime}</b> at <b> {trade.location.name}</b>
                            {" "} on <b>{ meetingDay} </b>
                        ...
                        <div> 
                            You're trading these items with <b>{trade.receiver.username}</b> at <b>{meetingtime}</b> at <b> {trade.location.name}</b>
                            {" "} on <b>{ meetingDay} </b>
